...
<div class="row">
    ...
    <div class="{{$viewClass['field']}}">
        <div id="has-many-{{$column}}" style="margin-top: 15px; width: 70%;">
                ...
                @foreach($forms as $pk => $form)
                    <tr class="has-many-{{$column}}-form fields-group">
                        ...
                        @if($options['allowDelete'])
                            <td class="form-group">
                                <div>
                                    <div class="remove-helper-amount btn btn-warning btn-sm pull-right"><i
            ...
            @if($options['allowCreate'])
                <div class="form-group">
                    <div class="{{$viewClass['field']}}">
                        <div class="add-helper-amount btn btn-success btn-sm"><i class="fa fa-save"></i>&nbsp;{{ trans('admin.new') }}
                        </div>
                    </div>
                </div>
            @endif
