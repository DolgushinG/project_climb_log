...
class Backup extends Extension
{
    ...
    protected static function registerRoutes()
    {
        parent::routes(function ($router) {
            ...
            $router->get('backup', 'App\Admin\Controllers\BackupController@index')->name('backup-list');
            $router->get('backup/download', 'App\Admin\Controllers\BackupController@download')->name('backup-download');
            $router->post('backup/run', 'App\Admin\Controllers\BackupController@run')->name('backup-run');
            $router->delete('backup/delete', 'App\Admin\Controllers\BackupController@delete')->name('backup-delete');
        });
    }
