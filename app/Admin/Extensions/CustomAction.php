...
use Encore\Admin\Actions\Authorizable;
 ...
 */
abstract class CustomAction extends \Encore\Admin\Actions\Action implements Renderable
{
    use Authorizable;
    ...
    protected function initInteractor()
    {
        ...
        if ($hasForm = method_exists($this, 'custom_form')) {
            $this->interactor = new CustomForm($this);
        }
...
SCRIPT;
    ...
    public function render()
    {
        ...
        $content = $this->html();
        if ($content && $this->interactor instanceof CustomForm) {
