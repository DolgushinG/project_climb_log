...
Route::group([
    ...
    Route::middleware(['owner'])->group(function ($router) {
        ...
        $router->get('exports/events/results/excel/semifinal/{id}', 'ResultRouteSemiFinalStageController@exportSemiFinalExcel')->name('exportSemiFinalExcel');
        $router->get('exports/events/results/excel/final/{id}', 'ResultRouteFinalStageController@exportFinalExcel')->name('exportFinalExcel');
        $router->get('exports/events/results/excel/qualification-final/{id}', 'ResultQualificationController@exportFranceSystemQualificationExcel')->name('exportFranceSystemQualificationExcel');
        $router->get('exports/events/results/excel/all/{id}', 'EventsController@exportAllExcel')->name('exportAllExcel');
        $router->get('exports/events/results/excel/full/{id}', 'EventsController@exportFullExcel')->name('exportFullExcel');
