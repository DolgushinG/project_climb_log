...
use App\Admin\CustomAction\CustomActions;
...
return [
    ...
    */
    ...
    |
    */
    'https' => env('ADMIN_HTTPS', env('APP_ENV') == 'prod'),
    ...
    */
    ...
    |
    */
    'login_background_image' => '/vendor/laravel-admin/AdminLTE/dist/img/hero-bg.jpg',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'grid_action_class' => CustomActions::class,
