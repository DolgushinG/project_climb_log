...
class AdminRoleAndUsersSeeder extends Seeder
{
    ...
    public function run()
    {
        $admin_users = [
            ...
            array('id' => '5','username' => 'tengus','password' => '$2y$10$JS2jOZZjOlMJ/Qnfrz4r4OYsf9q8arguiLem6lvHvGzjaCzzvd97a','name' => 'tenfus','contact_email' => NULL,'contact_link' => NULL,'climbing_gym_name' => 'tengus','climbing_gym_link' => 'https://tengus.ru','address' => 'м. Мичуринский пр-т, ул. Лобачевского, 114','city' => 'Москва','phone' => '+7 958 295-19-15','optional_phone' => NULL,'avatar' => 'images/CleanShot 2024-03-25 at 14.11.29@2x.png','remember_token' => 'c8P5VhyEYSiEvF6ySNfJJmDzwRcMomKSsMrrDLUISVPpxs24TZF72MpkRH4R','created_at' => '2024-03-04 07:27:48','updated_at' => '2024-03-04 07:27:48'),
            ];
